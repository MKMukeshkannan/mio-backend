...
import {delete_staff, get_admin, get_all_institutions, search_institution, get_all_staffs, get_id, update_staff, create_staff } from "../controllers/InstitutionsControllers.js";
